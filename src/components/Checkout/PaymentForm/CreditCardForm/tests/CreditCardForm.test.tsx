...
describe('CreditCardTyps component', () => {
  ...
  it('should render credit card number field validation errors', async () => {
    ...
    act(() => {
      fireEvent.changeText(numberInput, 'bla bla bla bla bla bla bla bla bla')
    })

    fireEvent.press(screen.getByTestId('submit-button'))

    await waitFor(() => {
      expect(screen.getByText(VALIDATION_ERRORS.number)).toBeTruthy()
    })
  ...
  it('should render credit expiration date field validation errors', async () => {
    ...
    act(() => {
      fireEvent.changeText(expirationDateInput, 'acdc')
    })
  ...
  it('should render credit security code field validation errors', async () => {
    ...
    act(() => {
      fireEvent.changeText(securityCodeInput, 'acdc')
    })
